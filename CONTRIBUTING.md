...
**Important work** comes in many forms. There are labels for [bugs](https://github.com/sholladay/url-type/labels/bug) and [easy](https://github.com/sholladay/url-type/labels/easy) vs [hard](https://github.com/sholladay/url-type/labels/hard) tasks. We also appreciate documentation, examples, tutorials, blogs, videos, books, and other supporting content.
